...
### Priorytet 1: System użytkowników i autoryzacji
1. Model użytkowników w Prisma
2. Endpointy rejestracji/logowania
3. JWT middleware
4. 5 poziomów ról: Super Admin, Administrator, Menadzer, Operator, Technik, Raporty
5. Komponenty logowania w React
